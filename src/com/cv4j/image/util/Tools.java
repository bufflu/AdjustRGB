...
public class Tools {
    ...
    /*public static void drawRects(@NotNull BufferedImage bitmap, @NotNull List<Rect> rectangles) {

        Graphics graphics = new SunGraphics2D();
        BufferedImageGraphicsConfig canvas = new BufferedImageGraphicsConfig(bitmap);
